...
namespace minidom
{
    ...
    /// <remarks></remarks>
        ...
        /// <remarks></remarks>
            ...
            {
                m_Key = reader.Read("Key", ref m_Key);
                m_UserID = reader.Read("UserID", ref m_UserID);
                m_SourceFile = reader.Read("SourceFile", ref m_SourceFile);
                m_TargetURL = reader.Read("TargetURL", ref m_TargetURL);
                m_UploadTime = reader.Read("UploadTime", ref m_UploadTime);
                m_FileSize = reader.Read("FileSize", ref m_FileSize);
                m_FileContent = reader.Read("FileContent", ref m_FileContent);
