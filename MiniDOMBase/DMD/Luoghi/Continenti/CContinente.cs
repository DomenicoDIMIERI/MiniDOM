...
namespace minidom
{
    public partial class Anagrafica
    {
            ...
            : Luogo
        {
            ...
            public CContinente(string nome)
                : base(nome)
            {
            }
            ...
            {
                return (obj is CContinente) && this.Equals((CContinente)obj);
            }
            ...
            /// <param name="obj"></param>
            /// <returns></returns>
            public virtual bool Equals(CContinente obj)
            {
            ...
            /// <summary>
            /// Restituisce o imposta la sigla della Continente
            /// </summary>
            public string Sigla
            {
                get
            ...
            {
                return minidom.Anagrafica.Luoghi.Continenti; //.Module;
            }
