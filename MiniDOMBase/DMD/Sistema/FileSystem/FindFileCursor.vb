...
Partial Class Sistema
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public NotInheritable Class FindFileCursor
        ...
        Private Sub Init()
            ...
            If (Me.m_IncludeSubDirs) Then
                Me.m_Results = My.Computer.FileSystem.GetFiles(path, FileIO.SearchOption.SearchAllSubDirectories, wildChars)
            Else
                Me.m_Results = My.Computer.FileSystem.GetFiles(path, FileIO.SearchOption.SearchTopLevelOnly, wildChars)
            End If
            Me.m_Index = 0
        End Sub
        ...
        Public Sub XMLSerialize(writer As XML.XMLWriter) Implements XML.IDMDXMLSerializable.XMLSerialize
            writer.WriteAttribute("Pattern", Me.m_Pattern)
            writer.WriteAttribute("AttributesMask", Me.m_AttributesMask)
            writer.WriteAttribute("IncludeSubDirs", Me.m_IncludeSubDirs)
            writer.WriteAttribute("Index", Me.m_Index)
