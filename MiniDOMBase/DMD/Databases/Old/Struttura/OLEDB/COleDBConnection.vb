...
Partial Public Class Databases
    ...
    Public Enum OleDbLockMode As Integer
        NotSet = 0
        TableLevelLock = 1
        RowLevelLock = 2
    End Enum
    ...
    Public Class COleDBConnection
        ...
        Private m_PersistSecurityInfo As Boolean
        Private m_LockingMode As OleDbLockMode


        Public Sub New()
            Me.m_Provider = "Microsoft.Jet.OLEDB.4.0" '"Microsoft.ACE.OLEDB.12.0"
            Me.m_LockingMode = OleDbLockMode.RowLevelLock
            Me.m_PersistSecurityInfo = False
        End Sub
        ...
        Public Property Provider As String
            ...
            End Get
            Set(value As String)
                If (Me.IsOpen) Then Throw New InvalidOperationException("La connessione è già aperta")
                Me.m_Provider = Strings.Trim(value)
            End Set
        End Property

        Public Property LockingMode As OleDbLockMode
            Get
                Return Me.m_LockingMode
            End Get
            Set(value As OleDbLockMode)
                If (Me.IsOpen) Then Throw New InvalidOperationException("La connessione è già aperta")
                Me.m_LockingMode = value
            End Set
        End Property

        Public Property PersistSecurityInfo As Boolean
            Get
                Return Me.m_PersistSecurityInfo
            End Get
            Set(value As Boolean)
                If (Me.IsOpen) Then Throw New InvalidOperationException("La connessione è già aperta")
                Me.m_PersistSecurityInfo = value
            End Set
        End Property
        ...
        Public Overridable Function GetConnectionString() As String
            ...
            Select Case Me.m_LockingMode
                ...
                Case Else
            End Select
            Select Case Me.AuthenticationType
            ...
            End Select
            Dim c As System.Net.NetworkCredential = Me.GetCredentials()
            If (c IsNot Nothing) Then
                'Provider=Microsoft.Jet.OLEDB.4.0; Data Source=d:\Northwind.mdb;User ID=Admin;Password=;
                ret.Append("User ID=" & c.UserName & ";")
                ret.Append("Password=" & c.Password & ";")
            End If
            Select Case Me.ShareMode
            ...
            If (Arrays.Len(Me.EncryptionKey) > 0) Then
                ret.Append("Jet OLEDB:Database Password=" & System.Text.Encoding.ASCII.GetString(Me.EncryptionKey) & ";")
            End If
