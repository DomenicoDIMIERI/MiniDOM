...
Partial Public Class Finanziaria
    ...
    Public Class CConteggioEstintivo
        ...
        Private Sub doOnSegnalata(ByVal e As ItemEventArgs)
            Me.OnSegnalata(e)
            Finanziaria.ConteggiEstintivi.doOnSegnalata(e)
        End Sub
        ...
        Private Sub doOnPresaInCarico(ByVal e As ItemEventArgs)
            ...
            Finanziaria.ConteggiEstintivi.doOnPresaInCarico(e)
        End Sub
        ...
        Public Overrides Function GetModule() As CModule
            Return Finanziaria.ConteggiEstintivi.Module
        End Function
        ...
        Public Overrides Function ToString() As String
            Return "Conteggi Estintivi: " & Me.m_NomeCliente & ", Pratica: " & Me.m_NumeroPratica
        End Function

        Protected Overrides Sub OnCreate(e As SystemEvent)
            MyBase.OnCreate(e)
            Finanziaria.ConteggiEstintivi.doItemCreated(New ItemEventArgs(Me))
        End Sub

        Protected Overrides Sub OnDelete(e As SystemEvent)
            MyBase.OnDelete(e)
            Finanziaria.ConteggiEstintivi.doItemDeleted(New ItemEventArgs(Me))
        End Sub

        Protected Overrides Sub OnModified(e As SystemEvent)
            MyBase.OnModified(e)
            Finanziaria.ConteggiEstintivi.doItemModified(New ItemEventArgs(Me))
        End Sub
    End Class
