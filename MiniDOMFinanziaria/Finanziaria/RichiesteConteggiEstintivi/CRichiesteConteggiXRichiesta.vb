...
Partial Public Class Finanziaria
    ...
    <Serializable> _
    Public Class CRichiesteConteggiXRichiesta
        Inherits CCollection(Of CRichiestaConteggio)
        ...
        Protected Overrides Sub OnInsert(index As Integer, value As Object)
            If (Me.m_RichiestaDiFinanziamento IsNot Nothing) Then DirectCast(value, CRichiestaConteggio).SetRichiestaDiFinanziamento(Me.m_RichiestaDiFinanziamento)
            MyBase.OnInsert(index, value)
        End Sub

        Protected Overrides Sub OnSet(index As Integer, oldValue As Object, newValue As Object)
            If (Me.m_RichiestaDiFinanziamento IsNot Nothing) Then DirectCast(newValue, CRichiestaConteggio).SetRichiestaDiFinanziamento(Me.m_RichiestaDiFinanziamento)
