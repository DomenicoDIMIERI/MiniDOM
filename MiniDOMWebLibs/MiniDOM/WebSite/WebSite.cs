...
namespace minidom
{
    ...
    /// <returns></returns>
        ...
        /// <summary>
        /// Restituisce o imposta un riferimento alla configurazione di sistema
        /// </summary>
        public SiteConfig Configuration
        {
            get
            {
                return WebSite.Instance.AppContext.WebSiteConfig;
            }
            set
            {
                WebSite.Instance.AppContext.WebSiteConfig = value;
                doConfigChanged(new System.EventArgs());
            }
        }
        ...
        public void ServeFile(string fileName, string fileType, string displayName, ServeFileMode mode, int bufferSize)
        {
            ...
            switch (mode)
            {
                ...
                case ServeFileMode.@default:
                    {
                        contentDisposition = minidom.Net.Mime.MIME.GetDefaultContentDispositionExtension(fileType);
                        break;
                    }
