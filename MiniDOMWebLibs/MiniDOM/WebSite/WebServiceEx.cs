...
namespace minidom
{
    public partial class WebSite
    {
        public class WebServiceEx : WebPageEx
        {
            ...
            // '    item.ActiveCount -= 1
            // '    item.MaxExecTime = Maths.Max(item.MaxExecTime, exeTime)
        ...
        /// <remarks></remarks>
            ...
            {
                string text = this.n2str("listCols");
            ...
            public virtual string ExportList()
            {
                ...
                string listFormat = DMD.Strings.LCase(DMD.Strings.Trim(this.n2str("listFormat", "xls")));
                switch (listFormat ?? "")
                {
            ...
            {
                using (Databases.DBObjectCursorBase cursor = (Databases.DBObjectCursorBase)DMD.XML.Utils.Serializer.Deserialize(this.n2str("cursor", "")))
                {
                    cursor.Reset1();
            ...
            protected virtual string ExportXlsFormat()
            {
                ...
                try
                {
                    cursor = (Databases.DBObjectCursorBase)DMD.XML.Utils.Serializer.Deserialize(this.n2str("cursor", ""));
                    cursor.Reset1();
                    cursor.PageSize = 10000;
                    // cursor.Count()
        ...
        /// <remarks></remarks>
            ...
            public virtual string ImportList()
            {
                ...
                {
                    fileName = Strings.Trim(this.n2str("fn"));
