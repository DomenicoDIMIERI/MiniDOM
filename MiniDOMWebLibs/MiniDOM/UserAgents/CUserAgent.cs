...
namespace minidom
{
    public partial class WebSite
    {
        public class CUserAgent : Databases.DBObjectBase
        {
            ...
            {
                this.m_UserAgent = reader.Read("UserAgent", this.m_UserAgent);
                this.m_DeviceType = reader.Read("DeviceType", this.m_DeviceType);
                this.m_Device = reader.Read("Device", this.m_Device);
                this.m_Bits = reader.Read("Bits", this.m_Bits);
                this.m_SistemaOperativo = reader.Read("SistemaOperativo", this.m_SistemaOperativo);
                this.m_VersioneSistemaOperativo = reader.Read("VersioneSistemaOperativo", this.m_VersioneSistemaOperativo);
                this.m_Browser = reader.Read("Browser", this.m_Browser);
                this.m_VersioneBrowser = reader.Read("VersioneBrowser", this.m_VersioneBrowser);
