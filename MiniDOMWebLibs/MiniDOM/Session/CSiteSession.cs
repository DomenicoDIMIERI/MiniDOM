...
namespace minidom
{
    public partial class WebSite
    {
        ...
        public class CSiteSession : Databases.DBObjectBase
        {
            ...
            {
                m_SessionID = reader.Read("SessionID", this.m_SessionID);
                ...
                m_Cookie = reader.Read("Cookie", this.m_Cookie);
                m_InitialReferrer = reader.Read("InitialReferrer1", this.m_InitialReferrer);
                if (string.IsNullOrEmpty(this.m_InitialReferrer))
                    this.m_InitialReferrer = reader.Read("InitialReferrer", this.m_InitialReferrer);
