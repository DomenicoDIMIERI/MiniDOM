...
namespace minidom
{
    ...
    /// </summary>
        [Serializable]
        public class CCollegamentiCursor : Databases.DBObjectCursor<CCollegamento>
        {
        ...
        /// <remarks></remarks>
            ...
            protected override void SetFieldInternal(string fieldName, object fieldValue)
            {
                switch (fieldName ?? "")
                {
                    case var @case when CultureInfo.CurrentCulture.CompareInfo.Compare(@case, "OnlyAssigned", CompareOptions.IgnoreCase | CompareOptions.IgnoreKanaType | CompareOptions.IgnoreWidth) == 0:
                        {
