    ...
    public partial class WebSite
    {
        ...
        /// <remarks></remarks>
            ...
            public CFileUploader()
            {
                ...
                m_Cancel = false;
                m_DestinationFile = "";
                m_BufferSize = Maths.Max(512, Instance.Configuration.UploadBufferSize);
        ...
        /// <remarks></remarks>
            public int BufferSize
            {
                ...
                set
                {
                    m_BufferSize = Maths.Max(512, value);
                    buffer = new byte[m_BufferSize];
                }
            }
        ...
        /// <remarks></remarks>
            ...
            protected virtual void LimitateSpeed(int nRead)
            {
                if (!IsCompleted() && Instance.Configuration.UploadSpeedLimit > 0)
                {
                    ...
                    {
                        delay = (int)Maths.Floor(BufferSize * 1000 / (double)Instance.Configuration.UploadSpeedLimit);
                    }

                    if (delay > 0)
                        Thread.Sleep(Maths.Min(delay, 2000));
                }
            }
